...
<script language="javascript" type="text/javascript" src="js/Kunyi.Init.js"></script><header><div class="topHidden"></div>
    ...
    <div class="BaseMark logoBase"><a href="/homepage/front.do"><img src="/images/img_logo_2.png" class="load" width="350px" /></a>
    ...
    <div class="baseRight">
        ...
        <div class="part">
            ...
            <div class="part01" id="Department1">
                <div class="partTitle">
                    <div class="left">${departmentsList.departmentName}</div>
                    <div class="right">
                        <a class='green' href='DutyTime-1.html'>出诊安排</a>
                    </div>
                </div>


                    <c:forEach items="${departmentsList.childList}" var="childList">
                <ul>
                    <li>
                        <span class='import1'></span><h3>${childList.departmentName}</h3><p>${childList.departmentDescription}</p>
                        <div>
                            <a class="coffee" href="keshimx.html" title="科室">查看详细</a>
                            <a class='green' href='/homepage/showDepartmentDoctors.do?departmentId=${childList.departmentId}' title='科室医生'>科室医生</a></div>
                    </li>
                </ul>
                    </c:forEach>
