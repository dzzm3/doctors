...
<script language="javascript" type="text/javascript" src="js/Kunyi.Init.js"></script><header><div class="topHidden"></div>
    ...
    <div class="BaseMark logoBase"<a href="Index.html"><img src="images/img_logo_2.png" width="350px" class="load"/></a>
    ...
    <div class="navBase">
        <div class="quickMenuBase" data-type="1">
            ...
            <div class="quickMenus"><ul class="firstUl">
                ...
                <li class="first"><a href="/homepage/front.do" target="_blank" class="firstA"><em>预约挂号</em><i class="style02"></i><span></span></a><div class="QMSub QMSubMenus">
                    <ul><li><a href="/homepage/getDepartmentsAll.do" >按科室预约<span>进入</span></a></li>
...
<section class="doctorsBase BaseMark" id="doctorsBase_id">
    ...
    <div class="contents">
        <ul data-num="0">
            ...
            <li><a href="ys.html" title="医生姓名" target="_blank" class="img">
                <img alt="姓名" title="姓名" src="${pageContext.request.contextPath}/${doctorsList.avatar}" style="width: 100px" width="120" height="162" /></a>

                <a href="/homepage/jumpToDoctor.do?jobNumber=${doctorsList.jobNumber}" title="医生姓名" target="_blank" class="name">${doctorsList.name}</a>
                <a href="/homepage/getDepartmentsAll.do" title="所在科室" target="_blank" class="office">${doctorsList.departments.departmentName}</a>
                <a href="/homepage/jumpToDoctor.do?jobNumber=${doctorsList.jobNumber}" title="职称" target="_blank" class="post">${doctorsList.titles.titleName}</a>
                <a href="/homepage/jumpToDoctor.do?jobNumber=${doctorsList.jobNumber}" title="详细" target="_blank" class="btn more">详细</a>
    ...
    <div class="contents">
        <ul data-num="0">
            ...
            <c:forEach items="${departmentsList}" var="departmentsList">
                ...
                <li><i class="ico01"></i>
                    <div class="img animated"><img alt="科室" src="pic/pic_008.png" width="80" height="80" /></div>
                    <a href="Office-4.html" title="科室" class="office">${departmentsList.departmentName}</a>
                    <p>${departmentsList.departmentDescription}</p>
                    <a href="Office-4.html" title="科室" class="btn more">查看详细</a>
                    <a href="ExpertInfo-4.html" title="科室医生" class="btn doctor">科室专家</a></li>
