...
<section class="BaseMark">
    <div class="bread">您所在的位置<span><a href="index.html">首页</a>><a href="ArticleList-54.html">就诊指南</a> > <a href="DepartmentNav.html">科室导航</a> > <a href="keshimx.html">${doctorsList[0].departments.departmentName}</a> > 专家介绍</span></div>
    <div class="baseLeft">
        <div class="partLeft">
            <div class="title partTitle"><a href="keshimx.html">${doctorsList[0].departments.departmentName}</a></div>
...
<c:forEach items="${doctorsList}" var="doctorsList">
                <li>
                    <a href="/homepage/jumpToDoctor.do?jobNumber=${doctorsList.jobNumber}" target="_blank">
                        <img src="${pageContext.request.contextPath}/${doctorsList.avatar}" class="load" width="120" height="162" title="医生" alt="医生"></a>
                    <a href="/homepage/jumpToDoctor.do?jobNumber=${doctorsList.jobNumber}" target="_blank" title="医生" class="ATitle">${doctorsList.name}</a>
                    <h4>${doctorsList.departments.departmentName}</h4>
                    <p>${doctorsList.titles.titleName}</p>
                    <div>
                        <a class="coffee" target="_blank" href="/homepage/jumpToDoctor.do?jobNumber=${doctorsList.jobNumber}">详细</a>
                        <a class="green" href="#" target="_blank">预约</a>
                    </div>
                </li>
</c:forEach>
            </ul>
