...
<section class="BaseMark" >
    ...
    <div class="doctorLeft">
        <img src="${pageContext.request.contextPath}/${doctors.avatar}" id="DThumb" class="DThumb" width="112" height="150" alt="医生" />
        <h3 id="H3Name">${doctors.name}</h3>
        <h4 id="H4Position">${doctors.titles.titleName}</h4>
    ...
    <div class="doctorRight">
        ...
        <div class="title01"><h3>所在科室：</h3><h1>${doctors.departments.departmentName}</h1><span><a href="Office-11.html" title="呼吸内科">进入科室</a></span></div>
        <div class="clear"></div>
        <div id="DIVContent" class="article intro"><p style="text-align:left;">
            <span style="font-family:'Tahoma';color:#121212;font-size:9pt;">${doctors.titles.titleName}，<span></span></span><span style="color:#121212;font-family:Tahoma;font-size:9pt;line-height:1.5;">${doctors.titles.titleName}，</span><span style="color:#121212;font-family:Tahoma;font-size:9pt;line-height:1.5;">${doctors.introduction}</span><span style="font-family:'Tahoma';color:#121212;font-size:9pt;"><span> </span></span>
        </p>
